...
public class VAEnvEasy extends VAEnvironment{

	public VAEnvEasy(Agent vacuumAgent, Point vacuumAgentPosition, VAFloor floor) {
	...
	protected VAPercept genPerception() {
		...
		VAPercept percept = new VAPercept(this.floor, this.vacuumAgentPosition, currentTileStatus, neighborhood);
		return percept;
	}
